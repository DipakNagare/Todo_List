...
const Delete = ({ toDoHandlers }) => {
    ...
    return (
        <div className="card m-5 p-5 mb-2 bg #aa8181">
            ...
            <div className="mt-5 has-text-centered mb-5">
                <button className="button is-danger is-halfwidth" onClick={() => { toDoHandlers.deleteToDoHandler(index) }}>Delete Todo</button>
            </div>
        </div>
    )
}
